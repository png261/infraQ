 ...
 * authentication state: no in-app authentication page for unauthenticated
 * users and chat interface for authenticated users.
 */
...
describe("Authentication State Routing", () => {
  ...
  it("should not render an in-app sign-in UI when user is not authenticated", () => {
    fc.assert(
      fc.property(
  ...
  it("should not provide an in-app sign-in button in unauthenticated state", () => {
    fc.assert(
